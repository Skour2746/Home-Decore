<%@ Page Title="" Language="C#" MasterPageFile="~/Home Frontend.master" AutoEventWireup="true" CodeFile="CategoryDetail.aspx.cs" Inherits="Admin_Category" %>
        ...
        <div class="dlab-bnr-inr dlab-bnr-inr-sm overlay-black-middle" style="background-image: url(Admin/images1/banner/slide2.jpg);">
            ...
            <div class="container">
                ...
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white"><%# Eval("category") %></h1>
                            ...
                            <div class="row">
                                <asp:ListView ID="listing_SubCategory" runat="server" ItemPlaceholderID="itemPlaceHolder1" GroupPlaceholderID="groupPlaceHolder1" OnPagePropertiesChanging="listing_SubCategory_PagePropertiesChanging">
                                    <LayoutTemplate>
                                        ...
                                        <asp:DataPager ID="DataPager1" runat="server" PagedControlID="listing_SubCategory" PageSize="3">
                                            <Fields>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="listing-bx listing-half m-b30">
                                                ...
                                                <div class="listing-info">
                                                    ...
                                                    <h6 class="title"><a href="ProductCategory.aspx?listing_cid=<%# Eval("MiniCid") %>"><%# Eval("Heading").ToString().PadRight(35).Substring(0,35).TrimEnd() %>.....</a></h6>
                                                    <p><%# Eval("Para").ToString().PadRight(40).Substring(0,40).TrimEnd() %>.....</p>
